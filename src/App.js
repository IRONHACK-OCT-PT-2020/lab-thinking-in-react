...
class App extends React.Component {
  ...
  showProducts = () => {
    return this.state.products.map(eachProduct => {
      return <li hidden={this.state.showAll && !eachProduct.stocked}>
      <span className={!eachProduct.stocked && "notInStock"}>{eachProduct.name}</span>  - {eachProduct.price} - {eachProduct.category}
          </li>
    })
  }
  search = (e) => {
  ...
  return (
    <div className="App">
      <input name="search" placeholder="search" onChange={this.search}></input>
